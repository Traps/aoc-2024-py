...
def test_part1_samples() -> None:
    ...
    assert part1_module.solve(samples[0]) == 161

def test_part1_challenge() -> None:
    challenge = get_challenge_input(DAY_NAME)

    assert part1_module.solve(challenge) == 168539636
...
def test_part2_samples() -> None:
    ...
    assert part2_module.solve(samples[0]) == 161
    assert part2_module.solve(samples[1]) == 48

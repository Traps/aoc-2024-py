...
def test_part1_samples() -> None:
    ...
    assert part1_module.solve(samples[0]) == 7036
    assert part1_module.solve(samples[1]) == 11048

def test_part1_challenge() -> None:
    challenge = get_challenge_input(DAY_NAME)

    assert part1_module.solve(challenge) == 105496
...
def test_part2_samples() -> None:
    ...
    assert part2_module.solve(samples[0]) == 45
    assert part2_module.solve(samples[1]) == 64

...
def test_part1_samples() -> None:
    ...
    assert part1_module.solve(samples[0]) == 126384

def test_part1_challenge() -> None:
    challenge = get_challenge_input(DAY_NAME)

    assert part1_module.solve(challenge) == 107934
...
def test_part2_samples() -> None:
    ...
    assert part2_module.solve(samples[0]) == 154115708116294

def test_part2_challenge() -> None:
    challenge = get_challenge_input(DAY_NAME)

    assert part2_module.solve(challenge) == 130470079151124
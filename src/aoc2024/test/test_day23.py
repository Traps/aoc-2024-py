...
def test_part1_samples() -> None:
    ...
    assert part1_module.solve(samples[0]) == 7

def test_part1_challenge() -> None:
    challenge = get_challenge_input(DAY_NAME)

    assert part1_module.solve(challenge) == 1083
...
def test_part2_samples() -> None:
    ...
    assert part2_module.solve(samples[0]) == 'co,de,ka,ta'

def test_part2_challenge() -> None:
    challenge = get_challenge_input(DAY_NAME)

    assert part2_module.solve(challenge) == 'as,bu,cp,dj,ez,fd,hu,it,kj,nx,pp,xh,yu'